 ...
 *	jquery.ui.core.js
 */
jQuery.plugin( 'jQuery.ui.datepicker', ['jQuery.ui.core', 'jQuery.i18n'], function( $, undefined ){
...
/* ======================================================================== *
 * BEGIN:	jQuery.i18n region support										*
 * ======================================================================== */
	var args = arguments,
		region, 
		calendar, 
	...
	if (region && (calendar = ($.i18n.regions[ region ] || {}).calendar)) {
		args[index] = $.extend({
			...
			shortYearCutoff : "+"+(calendar.twoDigitYearMax - new Date().getFullYear()),
			dateFormat		: calendar.patterns.d
									.replace(/dddd/,"DD")
									.replace(/ddd/,"D")
									.replace(/MMMM/,"@@")
									.replace(/MMM/,"@")
...
/* ======================================================================== *
 * END:		jQuery.i18n region support										*
 * ======================================================================== */
